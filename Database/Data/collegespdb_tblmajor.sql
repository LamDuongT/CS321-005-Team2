...
CREATE TABLE `tblmajor` (
  ...
  `majorDesc` mediumtext,
  `catalogID` int(11) NOT NULL,
  PRIMARY KEY (`majorID`),
  KEY `major_catalog_idx` (`catalogID`),
  CONSTRAINT `major_catalog` FOREIGN KEY (`catalogID`) REFERENCES `tblcatalog` (`catalogID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Major';
