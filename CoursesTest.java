...
{	
	...
	@Test public void courseEmptyConstructor()
	{
		Course c = new Course();
	}
	@Test public void getCourseByIDTest() {
		Courses coursesList  = new Courses(3);
	...
	@Test public void coursesSetConstructor() 
	{
		Courses coursesList  = new Courses(3);
	...
	@Test public void getCourseByNameTest() 
	{
		Courses coursesList  = new Courses(3);
	...
	@Test public void getCoursesListTest() 
	{
		Courses coursesList  = new Courses(3);
